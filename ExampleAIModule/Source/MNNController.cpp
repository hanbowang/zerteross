...
namespace BWAPI{
	//MNNController::MNNController(BWAPI::Player* selfPlayer, BWAPI::Player* enemyPlayer, std::string filename){
	MNNController::MNNController(BWAPI::Player* selfPlayer, std::string filename){

		// initialize the players
		self = selfPlayer;
		//enemy = enemyPlayer;

		// read configuration from MNNController_config.ini
		configFile = filename;
	...
	//void MNNController::initEnemy(BWAPI::Player* enemyPlayer){
	//	enemy = enemyPlayer;
	//	//enemyUnits = enemyUnitsIn;
	//}

	void MNNController::initUnits(BWAPI::Player* selfPlayer, BWAPI::Player* enemyPlayer){
		self = selfPlayer;
		enemy = enemyPlayer;
	...
	void MNNController::log(BWAPI::Player* selfPlayer, BWAPI::Player* enemyPlayer){
